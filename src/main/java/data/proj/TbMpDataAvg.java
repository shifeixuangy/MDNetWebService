 ...
 */
@Entity
@Table(name = "tb_mp_data_avg", schema = "")
@JsonNaming(PropertyNamingStrategy.PascalCaseStrategy.class)
public class TbMpDataAvg  implements SensorData{
    @JsonProperty("I")
    private int id;
    @JsonProperty("S")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TbMpDataAvg)) return false;

        TbMpDataAvg that = (TbMpDataAvg) o;

        if (Double.compare(that.accelerH, accelerH) != 0) return false;
        if (Double.compare(that.accelerX, accelerX) != 0) return false;
        if (Double.compare(that.accelerY, accelerY) != 0) return false;
        if (Double.compare(that.azimuth, azimuth) != 0) return false;
        if (Double.compare(that.dispH, dispH) != 0) return false;
        if (Double.compare(that.dispX, dispX) != 0) return false;
        if (Double.compare(that.dispY, dispY) != 0) return false;
        if (id != that.id) return false;
        if (sensorId != that.sensorId) return false;
        if (Double.compare(that.velocityH, velocityH) != 0) return false;
        if (Double.compare(that.velocityX, velocityX) != 0) return false;
        if (Double.compare(that.velocityY, velocityY) != 0) return false;
