 ...
 */
@Entity
@Table(name = "tb_weather_data_avg", schema = "")
@JsonNaming(PropertyNamingStrategy.PascalCaseStrategy.class)
public class TbWeatherDataAvg  implements SensorData{
    @JsonProperty("ID")
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TbWeatherDataAvg)) return false;

        TbWeatherDataAvg that = (TbWeatherDataAvg) o;
